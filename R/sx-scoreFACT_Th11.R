...
#' data.  As its default, \code{scoreFACT_Th11} DOES NOT replace any of your
...
#' frame returned by \code{scoreFACT_Th11}.
#' 
#' 
...
#'              paste0('GE', 1:6), 
#'              paste0('GF', 1:7))
#' AC_names <- c('An5', 'An7', 'Th1', 'Th2', 'Th3', 'Th5', 'Th7', 'Th8', 'Th10', 'Th12', 'Th13')
...
scoreFACT_Th11 <- function(df, updateItems = FALSE, keepNvalid = FALSE) {
    ...
    G_names <- c(paste0("GP", 1:7), paste0("GS", 1:7), paste0("GE", 1:6), 
        paste0("GF", 1:7))
    AC_names <- toupper(c("An5", "An7", "Th1", "Th2", "Th3", "Th5", "Th7", 
        "Th8", "Th10", "Th12", "Th13"))
    revNames <- toupper(c("Th1", "Th2", "Th3", "Th5", "Th7", "Th8", "Th10", 
        "Th12", "Th13"))
